...
#include "port/object.hpp"

namespace port {
    using nlohmann::json;


    struct instance : protected database::instance {
        const signal::instance::list incoming;
        const signal::instance::list outgoing;

    protected:
        const std::string type;
        instance(const port::object& p, signal::instance::list in, signal::instance::list out, const char* type) : database::instance(p), incoming(in), outgoing(out), type(type) {}
        instance(const json &j, const port::object& p, signal::instance::list in, signal::instance::list out, const char* type) : database::instance(j, p), incoming(in), outgoing(out), type(type) {}
    public:

        json serialize() const override {
            return this->::database::instance::serialize();
        }
        ...
        using database::instance::uuid;
        using database::instance::id;
        using database::instance::name;
        using database::instance::instance_name;
        using database::instance::prototype_id;
        using database::instance::direction;
        using database::instance::list;
        ...
        using database::instance::editor;
    };
