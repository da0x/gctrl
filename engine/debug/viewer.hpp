...
#include <string>
#include "ui/ui.hpp"
#include "machine/instance.hpp"
namespace debug {
    namespace viewer {

        std::optional<uint64_t> selected_driver_id;

        void render_signal_data(uint64_t id, const database::instance& instance, const std::map<uint64_t, std::vector<float>>& signal_data) {
        ...
        void render_signal_data_drag_drop(const database::instance& instance, const std::map<uint64_t, std::vector<float>>& signal_data) {
            return;
        ...
        std::vector<std::pair<uint64_t, const database::instance&>> collect_signals(const driver::instance& driver) {
            std::vector<std::pair<uint64_t, const database::instance&>> signal_list;
        ...
        void render_signals(const std::vector<std::pair<uint64_t, const database::instance&>>& signal_list, const std::map<uint64_t, std::vector<float>>& signal_data) {
        ...
        void render_ui(const std::vector<std::pair<uint64_t, const database::instance&>>& signal_list, const std::map<uint64_t, std::vector<float>>& signal_data) {
