...
namespace element {
    ...
    public:
        ...
        object() : controls::record("element"), frequency(exec::frequency::_1_khz) {
            code_block = "// Add your code here";
        }

        object(const nlohmann::json& j, const function::object::list& functions, const signal::object::list& signals) : controls::record("element", j), frequency(exec::frequency::_1_khz) {
