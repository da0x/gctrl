...
namespace driver {
    ...
    public:
        ...
        object() : database::record("driver"), frequency(exec::frequency::_1_hz) {}

        object(const nlohmann::json& j, const port::object::list& ports) : database::record("driver", j), frequency(exec::frequency::_1_khz) {
